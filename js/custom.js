(function ($) {
  ...
  $window.on("load", function () {
    ...
    var $path = current.substring(
      current.lastIndexOf("http://unicoderbd.com/") + 1
    );
  ...
  $(".color-panel").each(function () {
    ...
    $(".color-box li").each(function () {
      if (
        $.cookie("PropertyHub_color") &&
        $.cookie("PropertyHub_color") == $(this).attr("class")
      ) {
        $(this).addClass("active");
        var path = $(this).data("path");
        var logo1 = $(this).data("image");
    ...
    $(".color-box li").on("click", function () {
      ...
      $.cookie("PropertyHub_color", file_name, { path: "/", expires: 365 });
    });
